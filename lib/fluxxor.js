...
var _lodash13 = __webpack_require__(3);

var _lodash14 = _interopRequireDefault(_lodash13);

var _lodash15 = __webpack_require__(22);

var _lodash16 = _interopRequireDefault(_lodash15);

var _lodash17 = __webpack_require__(23);

var _lodash18 = _interopRequireDefault(_lodash17);

var _lodash19 = __webpack_require__(24);
...
var Dispatcher = function () {
    ...
    _createClass(Dispatcher, [{
        ...
        value: function _dispatch(action) {
            ...
            this.waitingToDispatch = (0, _lodash2.default)(this.stores);

            this.currentActionType = action.type;
            this.currentDispatch = (0, _lodash4.default)(this.stores, function () {
        ...
        value: function doDispatchLoop(action) {
            ...
            (0, _lodash6.default)(this.waitingToDispatch, function (value, key) {
                dispatch = _this.currentDispatch[key];
                canBeDispatchedTo = !dispatch.waitingOn.length || !(0, _lodash8.default)(dispatch.waitingOn, (0, _lodash10.default)(_this.waitingToDispatch)).length;
                if (canBeDispatchedTo) {
                    if (dispatch.waitCallback) {
                        var stores = (0, _lodash12.default)(dispatch.waitingOn, function (key) {
            ...
            if ((0, _lodash10.default)(this.waitingToDispatch).length && !dispatchedThisLoop.length) {
                var storesWithCircularWaits = (0, _lodash10.default)(this.waitingToDispatch).join(", ");
                throw new Error("Indirect circular wait detected among: " + storesWithCircularWaits);
            }

            (0, _lodash14.default)(removeFromDispatchQueue, function (key) {
                delete _this.waitingToDispatch[key];
            }, this);

            if ((0, _lodash16.default)(this.waitingToDispatch)) {
                this.doDispatchLoop(action);
            }
        ...
        value: function waitForStores(store, stores, fn) {
            ...
            var waitingStoreName = (0, _lodash18.default)(this.stores, function (val) {
                return val === store;
            });
            ...
            (0, _lodash14.default)(stores, function (storeName) {
            ...
            dispatch.waitingOn = (0, _lodash20.default)(dispatch.waitingOn.concat(stores));
...
var _create_store = __webpack_require__(25);
...
var _flux_mixin = __webpack_require__(32);

var _flux_mixin2 = _interopRequireDefault(_flux_mixin);

var _store_watch_mixin = __webpack_require__(36);

var _store_watch_mixin2 = _interopRequireDefault(_store_watch_mixin);

var _flux_child_mixin = __webpack_require__(37);
...
exports.default = function (spec) {
    (0, _lodash2.default)(RESERVED_KEYS, function (key) {
        if (spec[key]) {
        ...
        function StoreCreator(options) {
            ...
            for (var key in spec) {
                if (key === "actions") {
                    ...
                    // do nothing
                } else if ((0, _lodash4.default)(spec[key])) {
    ...
    _createClass(Store, [{
        ...
        value: function __handleAction__(action) {
            ...
            if (!!(handler = this.__actions__[action.type])) {
                if ((0, _lodash2.default)(handler)) {
                    handler.call(this, action.payload, action.type);
                } else if (handler && (0, _lodash2.default)(this[handler])) {
        ...
        value: function bindActions() {
            ...
            if (actions.length === 1 && (0, _lodash4.default)(actions[0])) {
                actions = actions[0];
...
var _objectPath = __webpack_require__(29);
...
var _lodash7 = __webpack_require__(31);
...
var Flux = function (_EventEmitter) {
    ...
    _createClass(Flux, [{
        ...
        value: function addAction() {
            ...
            if (!(0, _lodash6.default)(args[args.length - 1])) {
                throw new Error("The last argument to addAction must be a function");
            }

            var func = args.pop().bind(this.dispatchBinder);

            if (!(0, _lodash8.default)(args[0])) {
                args = args[0];
            }

            var leadingPaths = (0, _lodash4.default)(args, function (acc, next) {
                if (acc) {
            ...
            (0, _lodash2.default)(leadingPaths, function (path) {
                if ((0, _lodash6.default)(_objectPath2.default.get(_this2.actions, path))) {
...
var StoreWatchMixin = function StoreWatchMixin() {
    ...
    return {
        componentDidMount: function componentDidMount() {
            ...
            (0, _lodash2.default)(storeNames, function (store) {
