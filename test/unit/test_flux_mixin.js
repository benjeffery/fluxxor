...
describe("FluxMixin", function () {
    let FluxMixin, FluxChildMixin;
    let Parent, Child, Grandchild, GreatGrandchild, flux, objs;
    ...
    it("throws when attempting to mix in the function directly", function () {
        ...
        }).to.throw(/attempting to use a component class or function as a mixin/);
    });
