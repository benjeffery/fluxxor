...
import {Dispatcher, createStore} from "../.."


describe("Dispatcher", function () {
    let store1, store2, dispatcher;

    beforeEach(function () {
        let handleActionStub = sinon.stub();
    ...
    it("dispatches actions to every store", function () {
        let action = {type: "ACTION", payload: {val: 123}};
    ...
    it("detects indirect circular dependencies between stores", function () {
        ...
        dispatcher = new Dispatcher({Store1: store1, Store2: store2, Store3: store3});
        expect(function () {
            dispatcher.dispatch({type: "ACTION"});
